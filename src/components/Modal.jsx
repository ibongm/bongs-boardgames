    ...
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-3">
      ...
      >
        <div className="flex items-start justify-between gap-3">
          ...
          <button type="button" className="text-cream/70 hover:text-cream min-h-11 px-2" onClick={onClose}>
            Close
          </button>
        </div>
        <div className="mt-4 text-cream/85 text-sm leading-relaxed whitespace-pre-wrap">{children}</div>
