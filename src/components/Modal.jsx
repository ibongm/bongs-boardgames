  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-3">
      ...
      <div
        ...
        className="relative z-10 w-full max-w-lg max-h-[85vh] overflow-y-auto rounded-2xl border border-gold/30 bg-walnut p-5 shadow-table text-ink"
      >
        ...
        <div className="mt-4 text-ink text-sm leading-relaxed">{children}</div>
